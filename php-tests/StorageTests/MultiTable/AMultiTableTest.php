...
abstract class AMultiTableTest extends AMySqlTest
{
    ...
    `kwp_short` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
    `kwp_name` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
    `kwp_family` varchar(256) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
    `kwp_birth` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
    `kwp_death` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
    `kwp_successes` varchar(1024) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
    `kwp_sex` set('female','male') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'male',
    `kwp_text` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
    -- UNIQUE KEY `identifier` (`kwp_short`),
    INDEX `birth` (`kwp_birth`),
    INDEX `death` (`kwp_death`),
    INDEX `sex` (`kwp_sex`)
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Pedigree table';";
    }
...
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Pedigree relations';";
    }
