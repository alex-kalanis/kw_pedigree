...
//var_dump(['query dump' => str_split($sql->select($query), 120)]);
        ...
        $this->database->exec('INSERT INTO `kw_pedigree` (`pedigree_name`, `pedigree_family`, `pedigree_birth`, `pedigree_death`, `pedigree_father_id`, `pedigree_mother_id`, `pedigree_sex`, `pedigree_text`) VALUES ("William I.", "Dunkeld", "1142", "1214", 12, 13, "male", "");', []);
        $this->assertTrue($this->database->commit());
        $this->assertEquals(1, $this->database->rowCount());
        $this->assertTrue($this->database->beginTransaction());
        $this->database->exec('INSERT INTO `kw_pedigree` (`pedigree_name`, `pedigree_family`, `pedigree_birth`, `pedigree_death`, `pedigree_father_id`, `pedigree_mother_id`, `pedigree_sex`, `pedigree_text`) VALUES ("David", "of Huntingdon", "1152", "1219", 12, 13, "male", "");', []);
