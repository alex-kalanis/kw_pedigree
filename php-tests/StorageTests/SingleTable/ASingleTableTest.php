...
abstract class ASingleTableTest extends AMySqlTest
{
    ...
    `pedigree_name` varchar(75) COLLATE utf8mb4_unicode_ci NOT NULL,
    `pedigree_family` varchar(256) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
    `pedigree_short` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
    `pedigree_birth` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
    `pedigree_death` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
    `pedigree_father_id` INTEGER NULL,
    `pedigree_mother_id` INTEGER NULL,
    `pedigree_successes` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
    `pedigree_sex` set('female','male') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'male',
    `pedigree_text` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
